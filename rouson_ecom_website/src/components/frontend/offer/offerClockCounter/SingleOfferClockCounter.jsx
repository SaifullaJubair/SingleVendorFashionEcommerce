...
const SingleOfferClockCounter = ({startDate,endDate}) => {
     ...
     <div className='flex items-center gap-2.5'>
       {Object.entries(timeLeft).map(([unit, value], index) => {
         ...
         return (
           <div
             key={index}
             className='flex flex-col  space-y-1 items-center justify-center w-16 h-w-16 p-2'
           >
             <CircularProgressbar
               value={value}
               maxValue={max}
...
export default SingleOfferClockCounter
