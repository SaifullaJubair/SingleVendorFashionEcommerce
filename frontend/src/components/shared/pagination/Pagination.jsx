    ...
    <div className="flex justify-center my-6">
      <div className="mr-10 flex items-center gap-2">
        ...
        <select
          ...
          value={rows}
          id="rows_number"
          className="block w-full px-4 py-1 text-text-semiLight bg-white border border-gray-200 "
        >
      ...
      <button
        ...
        className="border flex items-center justify-center px-3 py-2 mx-1 text-gray-500 capitalize bg-white   hover:bg-[#22CD5A] hover:text-white"
      >
        <FaChevronLeft />
      </button>
      <button
