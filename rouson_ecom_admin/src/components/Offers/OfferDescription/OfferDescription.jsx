...
import ProductVariation from '../VariationDesCription/ProductVariation/ProductVariation'

const OfferDescription = ({ setShowDesCription, offerProductData }) => {
  //VariAtion State
  ...
  const showVariationDetail = (productVariation) => {
    ...
    setVariationData(productVariation)
  }
  ...
  return (
    <div>
      <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50'>
        <div className='relative overflow-hidden text-left bg-white rounded-lg shadow-xl w-[1050px] p-6 max-h-[100vh] overflow-y-auto scrollbar-thin'>
          <div className=''>
            <h3
                  ...
                  <div className='overflow-x-auto rounded-t-lg'>
                    <table className='min-w-full divide-y-2 divide-gray-200 bg-white text-sm'>
                      ...
                      <tbody className='divide-y divide-gray-200 text-center'>
                        {offerProductData?.map((product, i) => (
                          <tr
                            key={product?._id}
                          ...
                          >
                            ...
                            <td className='whitespace-nowrap px-4 py-2 text-gray-700'>
                              <button
                                ...
                                disabled={
                                  product?.offer_product_id?.is_variation ===
                                  false
                                }
                              >
                                <GoEye
                            ...
                            <td className='whitespace-nowrap px-4 py-2 '>
                              {product?.offer_product_id?.brand_id?.brand_name
                                ? product?.offer_product_id?.brand_id
                                    ?.brand_name
                                : '-'}
                            </td>
                          </tr>
